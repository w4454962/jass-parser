...
function parser.Integer10(neg, str)
    local int = math.floor(str)
    return Integer(neg, int, str, 10)
end

function parser.Integer16(neg, str)
    local int = math.floor(string.format("%d",'0x'..str))
...
function parser.Integer256(neg, str)
    ...
    elseif #str == 4 then
        ...
        int = str:sub(4, 4):byte() * 0x1000000 + str:sub(3, 3):byte() * 0x10000 + str:sub(2, 2):byte() * 100 + str:sub(1, 1):byte()--stringUnpack('>I4', str)
    else
        int = 0
    end
